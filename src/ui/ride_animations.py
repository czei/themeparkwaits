...
_SPECS = {
    ...
    "big_thunder_goat.bmp": ("combo", (("region_shift", dict(box=(4, 8, 24, 20), axis='y', amp=3, period=18, wave='hinge', hinge='right')), ("emitter", dict(box=(4, 10, 7, 13), vx=-0.1, vy=-0.3, jitter=0.3, rate=3, life=8, max_live=4, colors=(0xFFEE99, 0xFFAA33, 0xEE5511))))),
    ...
    "dinosaur.bmp": ("combo", (("region_shift", dict(box=(50, 12, 63, 14), axis='y', amp=2, period=26, wave='sine', half='pos')), ("blink", dict(box=(50, 7, 51, 7), color=0x36B03E, period=96, duty=8, delay=45)))),
