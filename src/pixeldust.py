...
class PixelDust(object):
    ...
    def iterate(self, accel):
        ...
        for grain in self.grains:
            ...
            velocity_squaredd = grain.velocity[0] * grain.velocity[0] + grain.velocity[1] * grain.velocity[1]
